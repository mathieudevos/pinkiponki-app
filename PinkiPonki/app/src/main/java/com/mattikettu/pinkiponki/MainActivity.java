...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView username = (TextView) header.findViewById(R.id.drawer_header_username);
        TextView email = (TextView) header.findViewById(R.id.drawer_header_email);
        username.setText(sharedPreferenceManager.getCurrentUsername());
        email.setText(sharedPreferenceManager.getCurrentEmail());
